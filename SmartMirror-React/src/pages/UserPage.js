...
function UserPage() {
  ...
  const filters = React.useMemo(() => ({
    ...
    // BEAUTY & FACE ENHANCEMENT (15)
    smooth_skin: { name: '💅 Smooth Skin', css: 'brightness(1.15) saturate(0.85) contrast(1.1) blur(0.4px)' },
    radiant_glow: { name: '✨ Radiant Glow', css: 'brightness(1.35) saturate(1.2) contrast(0.95)' },
    porcelain: { name: '🤍 Porcelain', css: 'brightness(1.2) saturation(0.8) contrast(1.15)' },
    doll_face: { name: '👧 Doll Face', css: 'brightness(1.25) saturate(1.4) contrast(1.1) blur(0.5px)' },
    dewy: { name: '💧 Dewy', css: 'brightness(1.3) saturate(1.1) contrast(0.9)' },
    luminous: { name: '💫 Luminous', css: 'brightness(1.4) saturate(1.3) blur(0.3px)' },
    glass_skin: { name: '🔮 Glass Skin', css: 'brightness(1.2) saturation(0.75) contrast(1.25)' },
    pearl: { name: '🌸 Pearl', css: 'brightness(1.15) saturate(0.9) contrast(1.15)' },
    velvety: { name: '🤎 Velvety', css: 'brightness(1.1) saturate(1.1) contrast(1.05) blur(0.3px)' },
    ethereal: { name: '☁️ Ethereal', css: 'brightness(1.3) saturate(0.8) contrast(0.95) blur(0.6px)' },
    honey_glow: { name: '🍯 Honey Glow', css: 'hue-rotate(10deg) brightness(1.25) saturate(1.3)' },
    cherry_pink: { name: '🍒 Cherry Pink', css: 'hue-rotate(340deg) brightness(1.2) saturate(1.4)' },
    rose_gold: { name: '💎 Rose Gold', css: 'hue-rotate(350deg) brightness(1.2) saturate(1.3) contrast(1.1)' },
    peach_cream: { name: '🍑 Peach Cream', css: 'hue-rotate(15deg) brightness(1.3) saturate(1.2)' },
    milky_white: { name: '🥛 Milky White', css: 'brightness(1.35) saturate(0.6) contrast(1.15)' },

    // CUTE & PLAYFUL (12)
    bubblegum: { name: '🎀 Bubblegum', css: 'hue-rotate(330deg) saturate(1.8) brightness(1.2) contrast(1.1)' },
    cotton_candy: { name: '🍭 Cotton Candy', css: 'hue-rotate(320deg) saturate(1.6) brightness(1.25) blur(0.3px)' },
    strawberry: { name: '🍓 Strawberry', css: 'hue-rotate(345deg) saturate(1.7) brightness(1.15)' },
    blush: { name: '💕 Blush', css: 'hue-rotate(340deg) saturate(1.5) brightness(1.15) contrast(0.95)' },
    cherry_blossom: { name: '🌸 Cherry Blossom', css: 'hue-rotate(330deg) saturate(1.4) brightness(1.2) blur(0.4px)' },
    sunset_blush: { name: '🌅 Sunset Blush', css: 'hue-rotate(15deg) saturate(1.6) brightness(1.2)' },
    candy_corn: { name: '🌽 Candy Corn', css: 'hue-rotate(35deg) saturate(1.8) brightness(1.25) contrast(1.1)' },
    lollipop: { name: '🍭 Lollipop', css: 'hue-rotate(280deg) saturate(2) brightness(1.2) contrast(1.15)' },
    bubble_tea: { name: '🧋 Bubble Tea', css: 'hue-rotate(20deg) saturate(1.7) brightness(1.2)' },
    sweetheart: { name: '💗 Sweetheart', css: 'hue-rotate(325deg) saturate(1.6) brightness(1.25)' },
    cupid: { name: '💘 Cupid', css: 'hue-rotate(340deg) saturate(1.8) brightness(1.2) contrast(1.1)' },
    angel: { name: '👼 Angel', css: 'brightness(1.4) saturate(1.1) contrast(0.9) blur(0.5px)' },

    // ROMANTIC & LOVED (10)
    romantic_glow: { name: '💓 Romantic', css: 'hue-rotate(330deg) saturate(1.5) brightness(1.2) blur(0.4px)' },
    love_notes: { name: '💌 Love Notes', css: 'hue-rotate(340deg) saturate(1.4) brightness(1.15) contrast(1.05)' },
    passion: { name: '🔥 Passion', css: 'hue-rotate(0deg) saturate(1.8) brightness(1.25) contrast(1.15)' },
    infatuation: { name: '💕 Infatuation', css: 'hue-rotate(330deg) saturate(1.6) brightness(1.2) contrast(1.1)' },
    sweeping: { name: '💫 Sweeping', css: 'hue-rotate(280deg) saturate(1.4) brightness(1.2) blur(0.5px)' },
    devoted: { name: '💖 Devoted', css: 'hue-rotate(325deg) saturate(1.5) brightness(1.15)' },
    adore: { name: '😍 Adore', css: 'hue-rotate(330deg) saturate(1.7) brightness(1.25)' },
    beloved: { name: '👑 Beloved', css: 'hue-rotate(340deg) saturate(1.3) brightness(1.2) contrast(1.1)' },
    smitten: { name: '😊 Smitten', css: 'hue-rotate(35deg) saturate(1.5) brightness(1.2)' },
    valentine: { name: '💝 Valentine', css: 'hue-rotate(330deg) saturate(1.8) brightness(1.2) contrast(1.15)' },

    // AESTHETIC & ENHANCED (13)
    soft_aesthetic: { name: '🎨 Soft Aesthetic', css: 'saturate(0.9) brightness(1.15) contrast(0.95) blur(0.3px)' },
    moodglow: { name: '🌙 MoodGlow', css: 'brightness(1.2) saturate(1.1) contrast(1.05)' },
    warm_vibe: { name: '🔥 Warm Vibe', css: 'hue-rotate(15deg) saturate(1.3) brightness(1.15)' },
    cool_vibe: { name: '❄️ Cool Vibe', css: 'hue-rotate(190deg) saturate(1.2) brightness(1.1)' },
    neutral_zen: { name: '☮️ Zen', css: 'saturate(0.85) brightness(1.1) contrast(1.05)' },
    editorial: { name: '📸 Editorial', css: 'contrast(1.3) brightness(1.05) saturate(1.15)' },
    magazine: { name: '📖 Magazine', css: 'saturate(1.2) contrast(1.25) brightness(1.1)' },
    instant_beauty: { name: '⚡ Beauty+', css: 'brightness(1.2) saturate(1.25) contrast(1.1) blur(0.3px)' },
    enhanced_face: { name: '✨ Enhanced', css: 'brightness(1.25) saturate(1.3) contrast(1.15)' },
    flawless: { name: '💎 Flawless', css: 'brightness(1.2) saturate(0.95) contrast(1.2) blur(0.4px)' },
    pristine: { name: '❄️ Pristine', css: 'brightness(1.3) saturate(0.85) contrast(1.2)' },
    perfect_light: { name: '💡 Perfect Light', css: 'brightness(1.35) contrast(1.1) saturate(1.1)' },
    soft_glow: { name: '🌟 Soft Glow', css: 'brightness(1.25) saturate(0.95) blur(0.5px) contrast(0.95)' },
  }), []);
